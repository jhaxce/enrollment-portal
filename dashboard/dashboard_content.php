                <div class="projects-section-line">
                  <div class="projects-status">
                    <div class="item-status">
                      ...
                      <span class="status-type">Pending Completion</span>
                    </div>
                    <div class="item-status">
                      <span class="status-number">0</span>
                      <span class="status-type">Under Review</span>
                    </div>
                    <div class="item-status">
                      <span class="status-number">0</span>
                      <span class="status-type">Verified</span>
                    </div>
                  </div>
                ...
                <div class="project-boxes jsListView">
                  <div class="project-box-wrapper">
                    <div class="project-box" style="background-color: #fee4cb;">
                      ...
                      <div class="project-box-content-header">
                        <p class="box-content-header">OMMANS</p>
                        <p class="box-content-subheader">P200.00</p>
                      </div>
                      <div class="box-progress-wrapper">
                        <p class="box-progress-header">Not Paid</p>
                  ...
                  <div class="project-box-wrapper">
                    <div class="project-box" style="background-color: #e9e7fd;">
                      ...
                      <div class="project-box-content-header">
                        <p class="box-content-header">JITS</p>
                        <p class="box-content-subheader">P890</p>
                      </div>
                      <div class="box-progress-wrapper">
                        <p class="box-progress-header">Not Paid</p>
                        <!-- <div class="box-progress-bar">
                  ...
                  <div class="project-box-wrapper">
                    <div class="project-box">
                      ...
                      <div class="project-box-content-header">
                        <p class="box-content-header">SSC</p>
                        <p class="box-content-subheader">P100</p>
                      </div>
                      <div class="box-progress-wrapper">
                        <p class="box-progress-header">Not Paid</p>
                        <!-- <div class="box-progress-bar">
                  ...
                  <div class="project-box-wrapper">
                    <div class="project-box" style="background-color: #ffd3e2;">
                      ...
                      <div class="project-box-content-header">
                        <p class="box-content-header">BAGWIS</p>
                        <p class="box-content-subheader">P80</p>
                      </div>
                      <div class="box-progress-wrapper">
                        <p class="box-progress-header">Not Paid</p>
                        <!-- <div class="box-progress-bar">
                  ...
                  <div class="project-box-wrapper">
                    <div class="project-box" style="background-color: #c8f7dc;">
                      ...
                      <div class="project-box-content-header">
                        <p class="box-content-header">PESO</p>
                        <p class="box-content-subheader">P80</p>
                      </div>
                      <div class="box-progress-wrapper">
                        <p class="box-progress-header">Not Paid</p>
                  ...
                  <div class="project-box-wrapper">
                    <div class="project-box" style="background-color: #d5deff;">
                      ...
                      <div class="project-box-content-header">
                        <p class="box-content-header">INSURANCE</p>
                        <p class="box-content-subheader">P100</p>
                      </div>
                      <div class="box-progress-wrapper">
                        <p class="box-progress-header">Not Paid</p>
